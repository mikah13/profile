    ...
    <footer className="w-full border-t h-48 mt-40 container flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row">
      <div className="container flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row">
        <p className="text-black dark:text-slate-200">
          ...
          <a
            target="_blank"
            className="cursor-pointer dark:textF-purple-300 text-violet-700  font-bold text-primary underline underline-offset-4 hover:text-pink-500 dark:hover:text-pink-500"
          >
            Mike Hoang
          </a>
